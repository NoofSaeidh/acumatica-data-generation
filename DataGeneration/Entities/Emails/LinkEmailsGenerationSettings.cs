...
{
    public class LinkEmailsGenerationSettings : GenerationSettings<LinkEmails, LinkEmailsRandomizerSettings>, ISearchGenerationSettings
    {
        ...
        public Searchment Searchment { get; set; }
    }
